...
def window_partition(x, window_size):
    ...
    output:(B * H//window_size * W//window_size, window_size, window_size, C)
    """
    B, H, W, C = x.shape
...
def window_reverse(windows, window_size, H, W):
    ...
    Returns:
        x: (B, H, W, C)
    input:(B * H//window_size * W//window_size, window_size, window_size, C)
    """
...
class WindowAttention(nn.Module):
    ...
    Args:
        ...
        window_size (tuple[int]): The height and width of the window. default=7*7
    ...
    def __init__(self, dim, window_size, num_heads, qkv_bias=True, qk_scale=None, attn_drop=0., proj_drop=0.):
        ...
        # coords: (2, window_size, window_size)
